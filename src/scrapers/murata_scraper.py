...
INPUT_FILE = os.path.join(DATA_DIR, "MurataProdList-MLCCs_InProduction.csv")
CACHE_FILE = os.path.join(DATA_DIR, "temp_vertical_cache.csv")
FINAL_OUTPUT = os.path.join(DATA_DIR, "Murata_SideBySide_Master.csv")
FAILURE_REPORT = os.path.join(DATA_DIR, "logs", "FINAL_FAILURES.txt")
